...
namespace fidelizPlus_back.Services
{
    ...
    public class CommercialLinkStandardService : CrudStandardService<CommercialLink, CommercialLink>, CommercialLinkService
    {
        private CommercialLinkRepository ClRepo { get; }

        public CommercialLinkStandardService(
